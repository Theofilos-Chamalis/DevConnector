        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <form noValidate onSubmit={this.onSubmit} /* Avoid the native html5 validation for email */ >
              <div className="form-group">
                <input type="text"
                       className={classnames('form-control form-control-lg', {'is-invalid': errors.name})}  // is-invalid class is rendered only if we have errors.name
